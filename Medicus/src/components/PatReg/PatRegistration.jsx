...
export default function RegisterSection() {
  ...
  const handleSubmit = async (e) => {
    ...
    const gender = e.target.elements[4].value;
    const password = e.target.elements[5].value;
    const confirmPassword = e.target.elements[6].value;
    ...
    try {
      ...
      if (resp?.patient?.patientId) {
        setRegisteredPatientId(resp.patient.patientId);
      ...
      {showSuccessModal && (
        <div className="id-modal-overlay" onClick={() => setShowSuccessModal(false)}>
          <div className="id-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="id-code">{registeredPatientId}</div>
